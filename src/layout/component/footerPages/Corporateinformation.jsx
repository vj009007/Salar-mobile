    ...
    <div>
      <header class="bg-gradient-dark">
        <div
          ...
          style={{
            backgroundImage:
              "url('https://wallpaperaccess.com/full/2643412.jpg')",
          ...
          <div className="row">
            <div className="col-10 mx-auto bg-gradient-dark border-radius-lg">
              <div className="row py-5">
                ...
                <div className="col-xl-8 col-md-5 z-index-2 position-relative px-md-3 px-5 my-md-auto mt-4">
                  <h2 style={{ color: "white" }}>Fully Integrated</h2>
      ...
      <div className="page-header min-vh-85 mt-lg-7 pt-3">
        <div
          className="position-absolute fixed-top ms-auto w-75 h-75 border-radius-xl z-index-1 d-none d-sm-none d-md-block me-n4"
          style={{
            backgroundImage:
          ...
          <div className="row mt-lg-7 pt-3 mb-5">
            <div className="col-lg-6 d-flex justify-content-center flex-column">
              <div className="card card-body d-flex justify-content-center shadow-lg border-radius-xl p-5 blur align-items-center z-index-2 shadow-blur">
                ...
                <p className="text-lg-start text-center mb-0">
                  We re constantly trying to express ourselves and actualize our
            ...
            <div className="col-lg-6 col-md-8 order-2 order-md-2 order-lg-1">
              <div className="position-relative">
                <div className="blur-shadow-image">
                  <img
                    src="https://demos.creative-tim.com/material-kit-pro/assets/img/dg2.jpg"
                    className="w-100 border-radius-xl img-fluid d-block mx-auto"
                    alt="carz"
                  />
                </div>
              </div>
            ...
            <div className="col-lg-5 col-md-12 me-auto">
              <div className="p-3 pt-0">
                ...
                <p>
                  ...
                  at colors. <br /> <br /> Before somebody tells you you shouldn
                  t like pink because that s for girls, or you d instantly
                  become a gay two-year-old. Why would anyone pick blue over
                  pink? Pink is obviously a better color.
                </p>
              </div>
            </div>
              ...
              <div className="position-relative">
                <div className="blur-shadow-image">
                  <img
                    ...
                    className="w-100 border-radius-xl mt-4 img-fluid d-block mx-auto"
                    alt="sunset"
                  />
                </div>
              </div>
