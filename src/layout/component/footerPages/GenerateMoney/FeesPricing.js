    ...
    <>
      <div class="card card-body shadow-xl mx-3 mx-md-4 mt-n6 pt-5">
        ...
        <div class="page-header min-vh-85">
          <div
            class="position-absolute fixed-top ms-auto w-75 h-75 border-radius-xl z-index-1 d-none d-sm-none d-md-block me-n4"
            style={{
              backgroundImage:
                "url(https://demos.creative-tim.com/material-kit-pro/assets/img/dg3.jpg)",
              ...
              <div class="col-lg-6 d-flex justify-content-center flex-column">
                <div class="card card-body d-flex justify-content-center shadow-lg border-radius-xl p-5 blur align-items-center z-index-2 shadow-blur">
                  <h2 class="text-dark mb-4">
                    Improving the design complexity
                  </h2>
                  ...
                  <div class="buttons w-100">
                    ...
                    <button
                      type="button"
                      class="btn btn-outline-dark mb-0 ms-1"
                    >
                      Read More
                    </button>
                  </div>
                  <div class="row mt-5 justify-content-start">
                    <div class="col-md-3 col-6 p-0">
                      <img
                        ...
                        src="https://demos.creative-tim.com/material-kit-pro/assets/img/logos/gray-logos/logo-pinterest.svg"
                        alt="logo"
                      />
                    </div>
                    <div class="col-md-3 col-6 p-0">
                      <img
                        class="w-100 opacity-6"
                        src="https://demos.creative-tim.com/material-kit-pro/assets/img/logos/gray-logos/logo-netflix.svg"
                        alt="logo"
                      />
                    </div>
                    <div class="col-md-3 col-6 p-0">
                      <img
                        class="w-100 opacity-6"
                        src="https://demos.creative-tim.com/material-kit-pro/assets/img/logos/gray-logos/logo-coinbase.svg"
                        alt="logo"
                      />
                    </div>
                    <div class="col-md-3 col-6 p-0">
                      <img
                        class="w-100 opacity-6"
                        src="https://demos.creative-tim.com/material-kit-pro/assets/img/logos/gray-logos/logo-nasa.svg"
                        alt="logo"
                      />
                    </div>
                  </div>
    ...
    <!------Banner Section--> */}
          ...
          <div class="row mt-5">
            <div class="col-md-5 ms-auto">
              <div
                ...
                style={{
                  backgroundImage:
                    "url('https://demos.creative-tim.com/material-kit-pro/assets/img/examples/blog1.jpg')",
                }}
              >
          ...
          <div class="row">
            ...
            <div class="col-md-5 me-auto">
              <div
                ...
                style={{
                  backgroundImage:
                    "url('https://demos.creative-tim.com/material-kit-pro/assets/img//examples/blog2.jpg')",
                }}
              >
                <div class="card-body z-index-2 py-9">
      ...
      <section class="bg-gradient-dark position-relative overflow-hidden mt-0">
        <img
          ...
          alt="pattern-lines"
          class="position-absolute opacity-1 w-100"
        />
          ...
          <div class="row">
            <div class="col-lg-6 d-flex justify-content-center flex-column">
              <div
                ...
                class="carousel slide py-7"
                data-bs-ride="carousel"
              >
                <div class="carousel-indicators justify-content-start ms-0">
                  <a href="javascript:;">
                    <img
                      src="https://demos.creative-tim.com/material-kit-pro/assets/img/team-4.jpg"
                      alt="..."
                  ...
                  <a href="javascript:;">
                    <img
                      src="https://demos.creative-tim.com/material-kit-pro/assets/img/team-3.jpg"
                      alt="..."
                  ...
                  <a href="javascript:;">
                    <img
                      src="https://demos.creative-tim.com/material-kit-pro/assets/img/team-2.jpg"
                      alt="..."
                      class="avatar avatar-sm avatar-scale-up border-radius-lg shadow border-0"
                      data-bs-target="#carouselExampleIndicator"
                      data-bs-slide-to="2"
