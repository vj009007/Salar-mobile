...
import { getFundsTransfer } from "../../repo/mywallet";
...
function Fundstransferhis() {
  ...
  const getSponserTeamByUser = async () => {
    ...
    let data = await getFundsTransfer(userid);
  ...
  if (searchText) {
    currentPosts =
      ...
      F.filter(
        (name) =>
          name.TransactionId === searchText || name.user_id === searchText
  ...
  //       reciever_userid: item.user_id,
  //       reciever_username: item.userName,
  ...
  //   },
  //   {
  //     title: "Reciever User Id",
  //     dataIndex: "reciever_userid",
  //     key: "reciever_userid",
  //     filterSearch: true,
  //     filterMode: "tree",
  //     filters: [],
  //     ...getColumnSearchProps("reciever_userid"),
  //   },
  //   {
  //     title: "Reciever User Name",
  //     dataIndex: "reciever_username",
  //     key: "reciever_username",
  //     filterSearch: true,
  //     filterMode: "tree",
  //     filters: [],
  //     ...getColumnSearchProps("reciever_username"),
  //   },
                ...
                <div class="container table-responsive">
                  ...
                  >
                    ...
                    >
                      <tr>
                        <th>S No</th>
                        <th>F.Transaction No</th>
                        <th>Reciever User Id</th>
                        <th>Reciever user Name</th>
...
export default Fundstransferhis;
