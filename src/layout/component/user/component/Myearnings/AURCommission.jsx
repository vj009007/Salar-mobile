...
import { getAurCommission } from "../../repo/commission";
...
function AURCommission() {
  ...
  const getSponserTeamByUser = async () => {
    ...
    let data = await getAurCommission(userid);
  ...
  if (searchText) {
    currentPosts =
      ...
      a
        .filter(
          (name) =>
            name.orderId === searchText || name.aurCommission === searchText
        )
  ...
  //       aur_commission: item.aurCommission,
  //     };
  //   });
  ...
  //   },
  //   {
  //     title: "AUR Commission",
  //     dataIndex: "aur_commission",
  //     key: "aur_commission",
  //     filterSearch: true,
  //     filterMode: "tree",
  //     filters: [],
  //     ...getColumnSearchProps("aur_commission"),
  //   },
  // ];
                        ...
                        currentPosts.map((item, i) => {
                          return (
                            <tr>
                              ...
                              <td className="text-sm">{}</td>
                              <td className="text-sm">{item.aurCommission}</td>
                            </tr>
                          );
                        })}
                      {/* <tr></tr> */}
